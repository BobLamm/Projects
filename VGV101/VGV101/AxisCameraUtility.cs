...
namespace Utility.AxisCamera
{
    public class AxisCameraUtility
    {
        ...
        public static void SetUpCameraMonitor(CameraObject camera/*DataGridView dataGridView1, int camNumber*/, AxAXISMEDIACONTROLLib.AxAxisMediaControl AMC, Label txtCamStatus)
